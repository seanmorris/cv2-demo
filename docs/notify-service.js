...
require.register("notify-service.js", function(exports, require, module) {
"use strict";var _Service=require("curvature/service/Service"),_Router=require("curvature/base/Router");importScripts("/curvature.js"),_Service.Service.serviceHandlers.add({routes:{"worker-echo":function workerEcho(){return JSON.stringify(_Router.Router.query.input)}}});
});
