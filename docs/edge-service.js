...
require.register("edge-service.js", function(exports, require, module) {
"use strict";var _CloudService=require("curvature/service/CloudService"),_Router=require("curvature/base/Router");_CloudService.CloudService.routeHandlers.add({ping:function ping(){return"pong!"},"worker-echo":function workerEcho(){return JSON.stringify(_Router.Router.query.input)},"event-source":function eventSource(){var a=new Headers;a.set("Access-Control-Allow-Methods","GET, OPTIONS"),a.set("Access-Control-Allow-Origin","*"),a.set("Cache-Control","no-cache"),a.set("Content-Type","text/event-stream"),a.set("Connection","keep-alive");var b=new TransformStream,c=b.readable,d=b.writable,e=d.getWriter(),f=new TextEncoder,g=Object.keys(Array(100).fill()).map(function(a){return{id:a}}),h=function(a,b){var c=Date.now();a.time=c;var d=JSON.stringify(a);e.write(f.encode("event: ".concat("ServerEvent","\n")+"data: ".concat(d,"\n")+"id: ".concat(c,"\n\n"))),b()},i=g.map(function(a,b){return new Promise(function(c){return setTimeout(function(){return h(a,c)},100*b)})});return Promise.all(i).then(function(){return e.close()}),new Response(c,{status:"200",statusText:"OK",headers:a})}});
});
