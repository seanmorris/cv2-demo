  ...
  _createClass(View, [{
    ...
    value: function mousedown(startEvent) {
      ...
      if (startEvent.target.matches('[data-resize="v"]')) {
        ...
        var _trackCount = this.args.ysize - 1;
...
module.exports = "<h2>grid-resize</h2>\n\n<p>[[rowTemplate]]</p>\n<p>[[colTemplate]]</p>\n\n<p class = \"row\"><b>--tracksize:</b> <input type = \"range\" min = \"0\" max = \"100\" cv-bind = \"trackSize\"/></p>\n\n<div\n\tclass = \"grid-resize\"\n\tstyle = \"\n\t\t--xsize:       calc([[xsize]] * 2);\n\t\t--ysize:       calc([[ysize]] * 2);\n\t\t--tracksize:   [[trackSize]]px;\n\t\t--colTemplate: [[colTemplate]];\n\t\t--rowTemplate: [[rowTemplate]];\n\t\">\n\n\t<span class = \"contents\">\n\t\t<div class = \"box\"><img src = \"/player-head-180.png\" /></div>\n\t\t<div class = \"box\">2</div>\n\t\t<div class = \"box\">3</div>\n\t\t<div class = \"box\">4</div>\n\t\t<div class = \"box\">5</div>\n\t\t<div class = \"box\">6</div>\n\t\t<div class = \"box\">7</div>\n\t\t<div class = \"box\">8</div>\n\t\t<div class = \"box\">9</div>\n\t\t<div class = \"box\">10</div>\n\t\t<div class = \"box\">11</div>\n\t\t<div class = \"box\">12</div>\n\t\t<div class = \"box\">13</div>\n\t\t<div class = \"box\">14</div>\n\t\t<div class = \"box\">15</div>\n\t\t<div class = \"box\">16</div>\n\t</span>\n\n\t<span class = \"contents\" cv-on = \"mousedown(event)\">\n\t\t<div style = \"--track:2\" data-resize = \"h\" class = \"resizer resizer-h\"></div>\n\t\t<div style = \"--track:4\" data-resize = \"h\" class = \"resizer resizer-h\"></div>\n\t\t<div style = \"--track:6\" data-resize = \"h\" class = \"resizer resizer-h\"></div>\n\t\t<div style = \"--track:2\" data-resize = \"v\" class = \"resizer resizer-v\"></div>\n\t\t<div style = \"--track:4\" data-resize = \"v\" class = \"resizer resizer-v\"></div>\n\t\t<div style = \"--track:6\" data-resize = \"v\" class = \"resizer resizer-v\"></div>\n\t</span>\n\n</div>\n"
});
...
var View = /*#__PURE__*/function (_BaseView) {
  ...
  _createClass(View, [{
    ...
    value: function blur(event) {
      var nodes = _toConsumableArray(this.tags.html.element.childNodes).filter(function (node) {
    ...
    key: "formatHtml",
    value: function formatHtml(nodes) {
      ...
      for (var i in nodes) {
        ...
        if (node.hasChildNodes()) {
          ...
          var child = this.formatHtml(_toConsumableArray(node.childNodes), depth + 1);
...
var InfiniteScroller = /*#__PURE__*/function (_Mixin$from) {
  ...
  _createClass(InfiniteScroller, [{
    ...
    value: function attached() {
      ...
      this.observer = new IntersectionObserver(function (e, o) {
      ...
      var scrollSnapType = container.style.scrollSnapType;
...
var _View13 = require("Experiments/InfiniteScroll/View");

var _View14 = require("Experiments/HtmlEditor/View");

var _View15 = require("Experiments/GridResizer/View");

var _View16 = require("Experiments/Php/View");
